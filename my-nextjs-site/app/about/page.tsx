        ...
        <div className={`flex w-full flex-col ${styles.pageDetailsContainer}`}>
          <div className="flex items-center justify-center flex-col">
            <div
              ...
              ref={
                sectionsRef.current[0] as LegacyRef<HTMLDivElement> | undefined
              }>
              {" "}
              {showLetters ? (
                <>
            ...
            <div
              className="mt-40"
              ref={
                sectionsRef.current[1] as LegacyRef<HTMLDivElement> | undefined
              }>
              <AboutMeText />
            </div>
            <div
            ...
            <div
              className="mt-40"
              ref={
                sectionsRef.current[3] as LegacyRef<HTMLDivElement> | undefined
              }></div>
