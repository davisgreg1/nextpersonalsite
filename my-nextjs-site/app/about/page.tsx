...
import scrollDown from "@/images/lottie/scrollDown.json";
...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-full h-full overflow-scroll flex items-center flex-col mt-6 ${styles.container}`}
      >
        <motion.div
        ...
        >
          <section
            className={`overflow-scroll ${styles.section} ${styles.scrollAndLottieSection}`}
          >
        ...
        <div ref={(el) => (sectionsRef.current[2] = el)} className="w-full p-4">
          <section
